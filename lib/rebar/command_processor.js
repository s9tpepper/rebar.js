var CommandProcessor = function CommandProcessor() {
  var commands = ["new","amd","cjs","feature","help"];
  var logger = CommandProcessor.Logger();

  var commandMap = {
    help:     CommandProcessor.HelpRunner,
    cjs:      CommandProcessor.CjsRunner,
    amd:      CommandProcessor.AmdRunner,
    new:      CommandProcessor.NewRunner
  };
...
CommandProcessor.NewRunner                = require("./command_processor/new_runner");
CommandProcessor.AmdRunner                = require("./command_processor/amd_runner");
CommandProcessor.CjsRunner                = require("./command_processor/cjs_runner");
CommandProcessor.HelpRunner               = require("./command_processor/help_runner");
